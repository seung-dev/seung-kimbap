import React, { DetailedHTMLProps, FormHTMLAttributes, HTMLAttributes } from "react";

import { AuthPageProps } from "@refinedev/core";

import { ForgotPasswordPage, LoginPage, RegisterPage, UpdatePasswordPage } from "./components";
