...
export const UpdatePasswordPage: React.FC<UpdatePasswordProps> = ({
	...
	const content = (
		<div {...contentProps}>
			<h1 style={{ textAlign: "center" }}>{translate("pages.updatePassword.title", "Update Password")}</h1>
			<hr />
			<form
				onSubmit={(e) => {
					e.preventDefault();
			...
			>
				...
				>
					<label htmlFor="password-input">{translate("pages.updatePassword.fields.password", "New Password")}</label>
					<input
						id="password-input"
						name="password"
						type="password"
					...
					<label htmlFor="confirm-password-input">
						{translate("pages.updatePassword.fields.confirmPassword", "Confirm New Password")}
					</label>
					<input
