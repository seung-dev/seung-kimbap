...
import { pickDataProvider, queryKeys, useInvalidate, useResource, useTranslate } from "@refinedev/core";
...
export const RefreshButton: React.FC<RefreshButtonProps> = ({
	...
	const { resources, identifier, id } = useResource(resourceNameFromProps ?? resourceNameOrRouteName);

	const isInvalidating = !!queryClient.isFetching({
		queryKey: queryKeys(identifier, pickDataProvider(identifier, dataProviderName, resources)).detail(recordItemId ?? id),
	});
